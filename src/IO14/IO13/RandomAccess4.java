...
public class RandomAccess4 {
    public static void main(String[] args) throws IOException {
        File file = new File("src/resources/cotton.jpg");
        // 总长度
        ...
        for (i = 0; i < size; i++) {
            ...
            File file1 = new File("src/resources/copy-cotton-" + i + ".jpg");
            random(i, beginPos, actualSize, file, file1);
        }
    }

    private static void random(int i, int beginPos, int actualSize, File file, File file1) throws IOException {
